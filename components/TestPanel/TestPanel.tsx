                    ...
                    {props.captionText.split(' ').map((word, i) => {
                        if (i < currentWordIndex) {
                            return (
                                <div
                                    key={i}
                                    className="text-gray-600 font-medium text-lg mx-1 border-solid  border-b-[2px] border-green-600 px-0.5"
                                >
                                    <span>{word}</span>
                                </div>
                            )
                            ...
                            return (
                                <div
                                    key={i}
                                    className="text-gray-900 font-medium text-lg mx-1 border-solid  border-b-[2px] border-gray-200 px-0.5 dark:border-white"
                                >
